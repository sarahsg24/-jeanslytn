...
<section class="add-products">
   ...
   <h1 class="title">add new product homme</h1>
            ...
            <option value="" selected disabled>select disponbité</option>
               ...
               <option value="rupture stock">rupture stock</option>
		          ...
		          <select name="hf" class="box" required>
					<option value="" selected disabled>select f</option>
					<option value="femme">femme</option>
				</select>
         </div>
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="enter product price" step="0.01">
         <input type="file" name="image" required class="box" accept="image/jpg, image/jpeg, image/png">
		 <input type="file" name="image_02" required class="box" accept="image/jpg, image/jpeg, image/png">
		 <input type="file" name="image_03" required class="box" accept="image/jpg, image/jpeg, image/png">
         </div>
      </div>
